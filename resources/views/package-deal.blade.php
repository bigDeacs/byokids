				...
				<div class="col-md-9 col-md-pull-3 col-sm-8 col-sm-pull-4 col-xs-12">
					...
					<div class="row">
						...
						@foreach($packages as $package)
							@if($package['deal_name'] !== $deal['deal_name'])
								<div class="col-sm-4 col-xs-12">
									...
									<div class="row">
										<div class="col-xs-12 text-center">
				                        	<p><strong><a href="{!! str_replace('?id=','/', $package['url']) !!}" class="post-title" title="{!! $package['deal_name'] !!}">
				                        		{!! str_limit($package['deal_name'], $limit = 30, $end = '...') !!}
				                        	</a></strong></p>
				                    	</div>
				                    </div>
									<p>{!! $package['destination'] !!}</p>			
									<p class="text-right"><a href="{!! str_replace('?id=','/', $package['url']) !!}" class="btn btn-read-more">Read More</a></p>
								</div>
							<?php $count ++; ?>
							@endif
