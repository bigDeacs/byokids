			...
			@if(isset($deal))
				<div class="col-md-3 col-md-push-9 col-sm-4 col-sm-push-8 col-xs-12">
				    ...
				    @if($enquire)
						...
						<p class="hidden-xs">Here at BYOkids we have dedicated travel and resort teams that can arrange your family holiday anywhere within Australia or the world.</p>
				...
				<div class="col-md-9 col-md-pull-3 col-sm-8 col-sm-pull-4 col-xs-12">
					...
					<div class="row">
						<div class="col-sm-6">
							<p><strong>Property:</strong> {!! $deal['Property'] !!}</p>
					...
					<div class="row">
						...
						@foreach($resorts as $resort)
							@if($resort['promo_code'] !== $deal['promo_code'])
								<div class="col-sm-4 col-xs-12">
									...
									<div class="row">
										<div class="col-xs-12 text-center">
				                        	<p><strong><a href="{!! str_replace('?id=','/', $resort['url']) !!}" class="post-title" title="{!! $resort['deal_name'] !!}">
				                        		{!! str_limit($resort['deal_name'], $limit = 30, $end = '...') !!}
				                        	</a></strong></p>
				                    	</div>
				                    </div>
									<p>{!! $resort['destination'] !!}</p>			
								<p>{!! $resort['Property'] !!}</p>	
									<p class="text-right"><a href="{!! str_replace('?id=','/', $resort['url']) !!}" class="btn btn-read-more">Read More</a></p>
								</div>
							<?php $count ++; ?>
							@endif
...
@section('scripts')
	<script>$("#resort").addClass("active");</script>
