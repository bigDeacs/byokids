		...
		<div class="row">
			@if(isset($deal))
				...
				<div class="col-md-9 col-md-pull-3 col-sm-8 col-sm-pull-4 col-xs-12">
					...
					<div class="row">
						<div class="col-sm-6">
							<p><strong>Tour Provider:</strong> {!! $deal['provider'] !!}</p>
							<p><strong>Destination:</strong> {!! $deal['region'] !!}</p>
						</div>
						<div class="col-sm-6">
					...
					<div class="row">
						...
						@foreach($tours as $tour)
							@if($tour['deal_name'] !== $deal['deal_name'])
								<div class="col-sm-4 col-xs-12">
									...
									<div class="row">
										<div class="col-xs-12 text-center">
				                        	<p><strong><a href="{!! str_replace('?id=','/', $tour['url']) !!}" class="post-title" title="{!! $tour['deal_name'] !!}">
				                        		{!! str_limit($tour['deal_name'], $limit = 30, $end = '...') !!}
				                        	</a></strong></p>
				                    	</div>
				                    </div>
									<p>{!! $tour['region'] !!}</p>			
								<p>{!! $tour['provider'] !!}</p>	
									<p class="text-right"><a href="{!! str_replace('?id=','/', $tour['url']) !!}" class="btn btn-read-more">Read More</a></p>
								</div>
							<?php $count ++; ?>
							@endif
